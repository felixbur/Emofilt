 ...
 * @author Felix Burkhardt
 */
public class DurVStop implements ModificationPlugin {
    private String name = "";

    private String type = "";

    private final String initFileName = "init/durVStop_init.txt";
    ...
    public Utterance modify(Utterance utt, Element emotion, double globalRate, Language lang) {
        ...
        for (Iterator iter = u.getSyllables().iterator(); iter.hasNext();) {
            ...
            syl.changeMannerSpeechRate(rate, Phoneme.stop_voiced);
        }
        return u;
    }
