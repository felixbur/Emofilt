 ...
 * @author Felix Burkhardt
 */
public class DurationFocusstressedSyls implements ModificationPlugin {
    private String name = "";

    private String type = "";

    private final String initFileName = "init/durationFocusstressedSyls_init.txt";
