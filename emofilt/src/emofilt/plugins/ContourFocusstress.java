...
/**
 * Modification Plugin to modify the contour of the focus-stressed syllables
 ...
 */
public class ContourFocusstress implements ModificationPlugin {
    ...
    private final String initFileName = "init/contourFocusstress_init.txt";
	...
	try {
	    initValues = Util.getValuesFromBufferedReader(new BufferedReader(
		    new InputStreamReader(Emofilt.class
			    .getResourceAsStream(initFileName))));
    ...
    public Utterance modify(Utterance utt, Element emotion, double globalRate,
	    Language lang) {
	int rate = 0;
