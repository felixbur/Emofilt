...
/**
 * Modification Plugin to modify the contour of the un-stressed syllables
 ...
 * @author Felix Burkhardt
 */
public class ContourUnstress implements ModificationPlugin {
    ...
    private final String initFileName = "init/contourUnstress_init.txt";
