 ...
 * @author Felix Burkhardt
 */
public class LastSylContour implements ModificationPlugin {
    ...
    private final String initFileName = "init/lastSylContour_init.txt";
    ...
    public Utterance modify(Utterance utt, Element emotion, double globalRate, Language lang) {
        ...
        Syllable syl = u.getLastVoicedSyllable();
